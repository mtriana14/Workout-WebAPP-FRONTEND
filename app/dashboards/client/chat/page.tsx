...
export default function ChatPage() {
    ...
    async function fetchConversation() {
      try {
        const res = await fetch(
          `${API_BASE}/chat/conversation?coach_id=${coachId}`,
          {
            headers: { Authorization: `Bearer ${getToken()}` },
          },
        );
  ...
  async function fetchMessages() {
    ...
    try {
      const res = await fetch(
        `${API_BASE}/chat/${conversation.conversation_id}/messages`,
        {
          headers: { Authorization: `Bearer ${getToken()}` },
        },
      );
              ...
              >
                <div
                  style={{
                    ...
                    height: 36,
                    borderRadius: "50%",
                    backgroundColor: "var(--hh-accent-20)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontWeight: 700,
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "var(--hh-text-muted)" }}>
                    Your Coach
                  </div>
                </div>
              </div>
