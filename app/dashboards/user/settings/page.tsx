...
const NAV_ITEMS = [
  { label: "Dashboard", href: "/dashboards/user", active: false },
  ...
  { label: "Settings", href: "/dashboards/user/settings", active: true },
];

const NOTIFICATIONS = [
  {
    label: "Workout reminders",
    sub: "Daily reminders at your preferred time",
    defaultOn: true,
  },
  {
    label: "Coach messages",
    sub: "Notifications for new coach messages",
    defaultOn: true,
  },
  {
    label: "Progress milestones",
    sub: "Celebrate your achievements",
    defaultOn: true,
  },
  {
    label: "Weekly summary",
    sub: "Weekly recap of your progress",
    defaultOn: false,
  },
];
        ...
        <div className="hh-dash-content" style={{ maxWidth: 720 }}>
          ...
          <div className="hh-card">
            ...
            <div className="hh-field" style={{ marginBottom: 12 }}>
              ...
              <textarea
                defaultValue="Focused on building lean muscle and improving overall performance."
                style={{
                  width: "100%",
                  height: 80,
                  padding: "10px 12px",
          ...
          >
            <h3 className="hh-panel-heading" style={{ color: "#f87171" }}>
              Danger Zone
            </h3>
            <p
              style={{
      ...
      {showDeleteModal && (
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ fontWeight: 600, color: "#f87171" }}>
                Delete Account
              </h3>
              <button
                onClick={() => setShowDeleteModal(false)}
