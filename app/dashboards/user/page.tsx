...
import { PlayCircle, Plus, Dumbbell } from "lucide-react";
      ...
      <main className="hh-dash-main">
        <div className="hh-dash-content">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, hsl(313 24% 20%), hsl(240 5% 14%))",
          ...
          >
            <div>
              <p
                ...
                style={{ fontSize: "var(--hh-fs-14)", marginBottom: 4 }}
              >
                Good morning 👋
              </p>
              <h2
              ...
              <p
                className="hh-text-muted"
                style={{ fontSize: "var(--hh-fs-14)", marginTop: 4 }}
              >
                Today is a{" "}
                <span
                  style={{ color: "var(--hh-accent-light)", fontWeight: 600 }}
                >
                  Push Day
                </span>
                ...
                {WORKOUT_EXERCISES.map((ex, i) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: "8px 0",
                      borderBottom:
                        i < WORKOUT_EXERCISES.length - 1
                          ? "0.6px solid var(--hh-border)"
                          : "none",
                    }}
                  >
                    <span
