      ...
      <div style={S.root}>
        ...
        <div className="login-right" style={S.right}>
          <div className="login-form-wrap" style={S.formWrap}>
            ...
            {/* Dev hint box — remove before production */}
            ...
            <div style={S.demoBox}>
              ...
              <div style={S.demoButtons}>
                <DemoPortalButton label="User Portal"  href="/dashboards/user"  />
                <DemoPortalButton label="Coach Portal" href="/dashboards/coach" />
                <DemoPortalButton label="Admin Portal" href="/dashboards/admin" />
              </div>
            </div>
...
const S: Record<string, React.CSSProperties> = {
  root: {
    ...
    background: "#111113", fontFamily: "'Inter', sans-serif",
  },
  left: {
  ...
  leftContent: { position: "relative", zIndex: 1, padding: "64px", width: "100%" },
  logoLink:    { display: "inline-flex", alignItems: "center", gap: 8 },
  logoIcon: {
    width: 36, height: 36, background: "#915985", borderRadius: 12,
    display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0,
  },
  logoText: {
    fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800,
    fontSize: 22.4, lineHeight: "33.6px", letterSpacing: "1.792px",
    color: "#f5f5f5", whiteSpace: "nowrap",
  },
  headline: {
    fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 900,
    fontSize: 56, lineHeight: "56px", letterSpacing: "0.56px",
    color: "#f5f5f5", marginTop: 24,
  },
  right: {
    flex: "0 0 50%", background: "#111113",
    display: "flex", alignItems: "center", justifyContent: "center", padding: 32,
  },
  formWrap:     { width: "100%", maxWidth: 448, display: "flex", flexDirection: "column" },
  headingGroup: { display: "flex", flexDirection: "column", gap: 4, marginBottom: 32 },
  h1: {
    fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800,
    fontSize: 32, lineHeight: "48px", letterSpacing: "0.32px", color: "#f5f5f5",
  },
  subtext: {
    fontFamily: "'Inter', sans-serif", fontSize: 14, fontWeight: 400,
    lineHeight: "20px", color: "#898994",
  },
  googleBtn: {
    width: "100%", height: 44, background: "#111113", border: "1px solid #2c2c30",
    borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center",
    fontFamily: "'Inter', sans-serif", fontSize: 14, fontWeight: 500,
    color: "#f5f5f5", cursor: "pointer", marginBottom: 16,
  },
  dividerWrap:  { display: "flex", alignItems: "center", height: 16, marginBottom: 16 },
  dividerLine:  { flex: 1, height: "0.6px", background: "#2c2c30" },
  dividerLabel: {
    fontFamily: "'Inter', sans-serif", fontSize: 12, fontWeight: 400,
    lineHeight: "16px", color: "#898994", background: "#111113",
    padding: "0 8px", whiteSpace: "nowrap",
  },
  form:       { display: "flex", flexDirection: "column", gap: 16, marginBottom: 16 },
  ...
  inputIcon: { position: "absolute", left: 12, pointerEvents: "none", flexShrink: 0 },
  input: {
    width: "100%", height: 44, background: "#1b1b1d", border: "1px solid #2c2c30",
    borderRadius: 10, paddingLeft: 40, paddingRight: 40,
    fontFamily: "'Inter', sans-serif", fontSize: 14, fontWeight: 400,
  ...
  errorMsg: {
    fontFamily: "'Inter', sans-serif", fontSize: 12, fontWeight: 400,
    lineHeight: "16px", color: "#f87171", marginTop: -8,
  },
  signInBtn: {
    width: "100%", height: 44, background: "#915985", border: "none",
    borderRadius: 10, fontFamily: "'Inter', sans-serif", fontSize: 14, fontWeight: 600,
    color: "#fff", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center",
  },
  /* Dev hint */
  hintBox: {
    background: "#1a1a1c", border: "1px dashed #2c2c30", borderRadius: 10,
    padding: "12px 14px", marginBottom: 12,
    display: "flex", flexDirection: "column", gap: 4,
  },
  hintTitle: {
    fontFamily: "'Inter', sans-serif", fontSize: 11, fontWeight: 600,
    color: "#ab87a3", marginBottom: 4,
  },
  hintRow: {
    fontFamily: "monospace", fontSize: 11, fontWeight: 400,
    color: "#898994", lineHeight: "18px",
  },
  hintRole: {
    display: "inline-block", minWidth: 48, fontWeight: 600, color: "#f5f5f5",
  },
  /* Demo portals */
  demoBox: {
    background: "#222225", border: "1px solid #2c2c30", borderRadius: 12,
    padding: "16.6px", display: "flex", flexDirection: "column", gap: 12, marginBottom: 16,
  },
  demoLabel: {
    fontFamily: "'Inter', sans-serif", fontSize: 12, fontWeight: 500,
    lineHeight: "16px", color: "#898994",
  },
  demoButtons: { display: "flex", flexWrap: "wrap" as const, gap: 8 },
  portalBtn: {
    display: "inline-flex", alignItems: "center", justifyContent: "center",
    background: "rgba(145, 89, 133, 0.2)", border: "1px solid rgba(145, 89, 133, 0.3)",
    borderRadius: 9999, padding: "4.6px 12.6px",
    fontFamily: "'Inter', sans-serif", fontSize: 12, fontWeight: 600,
    lineHeight: "16px", color: "#ab87a3", whiteSpace: "nowrap" as const, cursor: "pointer",
  },
  signupPrompt: {
    fontFamily: "'Inter', sans-serif", fontSize: 14, fontWeight: 400,
    lineHeight: "20px", color: "#898994", textAlign: "center" as const,
  },
  signupLink: {
    fontFamily: "'Inter', sans-serif", fontSize: 14, fontWeight: 500,
    lineHeight: "20px", color: "#915985", cursor: "pointer",
  },
};