...
export default function LoginPage() {
  ...
  function handleGoogleDemo() {
    alert("DEMO: OAuth Google Sign-In triggered. Redirecting to dashboard...");
    window.location.assign("/dashboards/user");
  }
    ...
    <div className="auth-root">
      <div className="auth-left">
        ...
        <div className="auth-left__content">
          ...
          <h2 className="auth-left__headline">YOUR BEST ERA<br />STARTS HERE.</h2>
        </div>
      </div>
      ...
      <div className="auth-right">
        <div className="auth-form-wrap">
          ...
          <form className="hh-form" onSubmit={handleSubmit} noValidate>
            <div className="hh-field">
              ...
              <div className="hh-input-wrap">
                ...
                <input
                  id="email" type="email" placeholder="you@email.com" autoComplete="email" className="hh-input"
            ...
            <div className="hh-field">
              <div className="hh-field__row">
                ...
                {/* WIRING UP THE FORGOT PASSWORD LINK HERE */}
                <Link href="/auth/forgot-password" className="hh-forgot-link" style={{ textDecoration: 'underline' }}>
                  Forgot password?
                </Link>
              </div>
              <div className="hh-input-wrap">
                ...
                <input
                  ...
                  autoComplete="current-password" className="hh-input"
          ...
          <p className="hh-auth-prompt" style={{ marginTop: 24 }}>
            Don&apos;t have an account? <Link href="/auth/signup" className="hh-auth-prompt__link">Create one</Link>
          </p>
        </div>
      </div>
    </div>
